...
#example: sbatch ./scripts/rbb.irl.v1.2.sh ~/data/genomes_key_rosales30042021.txt ~/../../scratch/projects/illorens/Motif_search/NINbe/YUCCA/YUCCA.protforblast.fasta YUCCA
#sbatch ./scripts/rbb.irl.sh ~/data/genomes_key_rosales30042021.txt LBD16forblast.fasta LBD16
#sbatch ./scripts/rbb.irl.v1.2.sh ~/data/genomes_key_rosales30042021.txt ~/../../scratch/projects/illorens/Motif_search/NINbe/NIN2/ninnlp.targets.fasta NIN2

#to do:

#sbatch ./scripts/rbb.irl.v1.2.sh ~/data/genomes_key_rosales30042021.txt ~/../../scratch/projects/illorens/Motif_search/NINbe/YUCCA/YUCCA.protforblast.fasta YUCCA
#sbatch ./scripts/rbb.irl.v1.2.sh ~/data/genomes_key_rosales30042021.txt ~/../../scratch/projects/illorens/Motif_search/NINbe/NIN3/ninnlp.targets.fasta NIN3
#sbatch ./scripts/rbb.irl.v1.2.sh ~/data/genomes_key_rosales30042021.txt ~/../../scratch/projects/illorens/Motif_search/NINbe/RPG/RPG.forblast.fasta RPG
#sbatch ./scripts/rbb.irl.v1.2.sh ~/data/genomes_key_rosales30042021.txt ~/../../scratch/projects/illorens/Motif_search/NINbe/LYK3/LYK3.proteins.fasta LYK3



GENOME_LOC=$1  #FULL PATH
TARGET=$2 #*.protforblast.fasta FULL PATH
...
#blastx -query ~/../../scratch/projects/illorens/data/genomes_available/Glymax.fna -db ../NIN2 -max_target_seqs 1 -outfmt 6 -evalue 1e-3 -num_threads 30 > blast.outfmt6
#tblastn -query ../ninnlp.legume.targets.fasta -db ~/../../scratch/projects/illorens/Motif_search/NINbe/blast_db/Glymax.fna -max_target_seqs 1 -outfmt 6 -evalue 1e-3 -num_threads 30 > blast_reciprocal.outfmt6

#tblastn -query ../ninnlp.legume.targets.fasta -db ~/../../scratch/projects/illorens/Motif_search/NINbe/blast_db/Lupang.fna -max_target_seqs 1 -outfmt 6 -evalue 1e-3 -num_threads 30 > blast_reciprocal.outfmt6
#need to remake blast db for the genomes of LUPANG and GLYMAX!!
