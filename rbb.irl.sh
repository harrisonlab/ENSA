...
#example: sbatch ./scripts/rbb.irl.sh ~/data/genomes_key_rosales30042021.txt YUCCA.protforblast.fasta YUCCA
...
#made this database in NINbe/blast_db
#makeblastdb -in ../ninnlp.targets.fasta -dbtype prot -out ninnlp.targets
...
#blastx -query ~/../../scratch/projects/illorens/data/genomes_available/${genome} -db ../blast_db/ninnlp.targets -max_target_seqs 1 -outfmt 6 -evalue 1e-3 -num_threads 30 > blast.outfmt6
#Switch query and search paths for reciprocal search
tblastn -query ~/../../scratch/projects/illorens/Motif_search/NINbe/${GENE}/${TARGET} -db ${genome} -max_target_seqs 1 -outfmt 6 -evalue 1e-3 -num_threads 30 > blast_reciprocal.outfmt6

#tblastn -query ~/../../scratch/projects/illorens/Motif_search/NINbe/LBD16/LBD16forblast.fasta -db Distri -max_target_seqs 1 -outfmt 6 -evalue 1e-3 -num_threads 30 > blast_reciprocal.outfmt6
#tblastn -query ../ninnlp.targets.fasta -db ${genome} -max_target_seqs 1 -outfmt 6 -evalue 1e-3 -num_threads 30 > blast_reciprocal.outfmt6
